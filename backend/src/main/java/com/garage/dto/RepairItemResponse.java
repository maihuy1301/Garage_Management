...
public class RepairItemResponse {
    ...
    public RepairItemResponse(Integer maChiTiet, Integer maPhieuSuaChua, Integer maDichVu,
                              String tenDichVu, Integer maLoaiDichVu, String tenLoaiDichVu,
                              BigDecimal donGia, BigDecimal thanhTien, String trangThai) {
