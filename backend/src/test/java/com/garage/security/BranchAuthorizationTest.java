...
class BranchAuthorizationTest {
    ...
    @Test
    void admin_CanAccessBranch1() throws Exception {
    ...
    @Test
    void admin_CanAccessBranch2() throws Exception {
        NguoiDung admin = mockUser(1, "admin");
        VaiTro adminRole = mockRole(1, "ROLE_ADMIN");
        stubUser(admin, adminRole, null);
    ...
    @Test
    void branchManager_Branch1_CanAccessBranch1() throws Exception {
        NguoiDung manager = mockUser(2, "manager");
        VaiTro mgrRole = mockRole(2, "ROLE_MANAGER");
        ChiNhanh cn1 = mockBranch(1, "Chi Nhánh 1");
        NhanVien emp = mockEmployee(manager, cn1);
    ...
    @Test
    void branchManager_Branch1_DeniedBranch2() throws Exception {
        NguoiDung manager = mockUser(2, "manager");
        VaiTro mgrRole = mockRole(2, "ROLE_MANAGER");
        ChiNhanh cn1 = mockBranch(1, "Chi Nhánh 1");
        NhanVien emp = mockEmployee(manager, cn1);
    ...
    @Test
    void frontDesk_Branch1_CanAccessBranch1() throws Exception {
        NguoiDung rec = mockUser(3, "frontdesk");
        VaiTro recRole = mockRole(3, "ROLE_FRONT_DESK");
        ChiNhanh cn1 = mockBranch(1, "Chi Nhánh 1");
        NhanVien emp = mockEmployee(rec, cn1);
    ...
    @Test
    void frontDesk_Branch1_DeniedBranch2() throws Exception {
        NguoiDung rec = mockUser(3, "frontdesk");
        VaiTro recRole = mockRole(3, "ROLE_FRONT_DESK");
        ChiNhanh cn1 = mockBranch(1, "Chi Nhánh 1");
        NhanVien emp = mockEmployee(rec, cn1);
    ...
    @Test
    void technician_Branch1_CanAccessBranch1() throws Exception {
        NguoiDung tech = mockUser(4, "technician");
        VaiTro techRole = mockRole(4, "ROLE_TECHNICIAN");
        ChiNhanh cn1 = mockBranch(1, "Chi Nhánh 1");
        NhanVien emp = mockEmployee(tech, cn1);
    ...
    @Test
    void technician_Branch1_DeniedBranch2() throws Exception {
        NguoiDung tech = mockUser(4, "technician");
        VaiTro techRole = mockRole(4, "ROLE_TECHNICIAN");
        ChiNhanh cn1 = mockBranch(1, "Chi Nhánh 1");
        NhanVien emp = mockEmployee(tech, cn1);
    ...
    // ---------------------------------------------------------------
    // Cross-branch: Branch 2 manager → Branch 1 denied
    // ---------------------------------------------------------------

    @Test
    void branchManager_Branch2_DeniedBranch1() throws Exception {
        NguoiDung mgr2 = mockUser(6, "manager2");
        VaiTro mgrRole = mockRole(2, "ROLE_MANAGER");
        ChiNhanh cn2 = mockBranch(2, "Chi Nhánh 2");
        NhanVien emp = mockEmployee(mgr2, cn2);
    ...
    @Test
    void branchManager_Branch2_CanAccessBranch2() throws Exception {
        NguoiDung mgr2 = mockUser(6, "manager2");
        VaiTro mgrRole = mockRole(2, "ROLE_MANAGER");
        ChiNhanh cn2 = mockBranch(2, "Chi Nhánh 2");
        NhanVien emp = mockEmployee(mgr2, cn2);
